        ...
        <div className="w-full space-y-6">
          <Card className="space-y-5">
            <div className="space-y-2">
              <h1 className="text-center text-4xl font-semibold text-[var(--color-ink)]">
                Регистрация
              </h1>
            </div>
            <RegisterForm />
          ...
          <Card className="space-y-4 bg-[var(--color-panel)]">
            <div className="rounded-[24px] border border-[var(--color-line)] bg-white p-4">
              <div className="flex items-center gap-3">
                <Link2 size={18} className="text-[var(--color-accent-deep)]" />
                <p className="font-medium text-[var(--color-ink)]">okno.app/alina-nails</p>
              </div>
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              {[
                ...
                <div key={item} className="flex items-center gap-3 rounded-[18px] bg-white px-4 py-3">
                  ...
                  <p className="text-sm text-[var(--color-ink-soft)]">{item}</p>
                </div>
              ))}
            </div>
